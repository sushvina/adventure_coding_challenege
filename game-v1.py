        ...
        if ans.upper() == "NO":
            ...
            while balajee == "one":
                if question.upper() == "READ MESSAGES":
                    ...
                    print("\n[00:38] Sugumaran, Balajee:\nWe evacuated the office after all the strange noises and earthquakes but you were sleeping so soundly no one dared wake you!")
                    print("\n[00:38] Sugumaran, Balajee:\nLindsey was taken by one of those THINGS. You need to find her and get out of there! We sealed the doors and only Lindsey's pass will able to open them! ")
